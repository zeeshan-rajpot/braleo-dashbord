...
import Editspotlight from "./Pages/Advertising/UpdatePages/EditSpotlight.jsx";
...
import EdittextAdd from "./Pages/Advertising/UpdatePages/EditTextAds.jsx";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/EdittextAdd/:id" element={<EdittextAdd />} />
